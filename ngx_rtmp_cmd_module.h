...
#define NGX_RTMP_OCLP_PLAY_NOTIFY          0
#define NGX_RTMP_OCLP_PUBLISH_NOTIFY       1
#define NGX_RTMP_OCLP_META_NOTIFY          5
...
ngx_int_t ngx_rtmp_cmd_stream_init(ngx_rtmp_session_t *s, u_char *name,
        u_char *args, unsigned publishing);
